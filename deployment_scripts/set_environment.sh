...
export SIRMIONE_ALIAS=kk1812sirmione
export LIMONE_ALIAS=kk1812limone
export SCORPIO_ALIAS=kk1812scorpio
export VIRGO_ALIAS=kk1812virgo
export LIBRA_ALIAS=kk1812libra
export ZODIAC_ALIAS=kk1812zodiac
export DB_ADMIN_USER=Karthik
